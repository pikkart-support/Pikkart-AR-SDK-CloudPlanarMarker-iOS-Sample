...
class ViewController: PKTRecognitionController {
    ...
    var _blue_monkeyMesh:Mesh?
    
    
    @objc internal func doRecognition(_ sender:Any) {
    ...
    override func viewDidLoad() {
        ...
        // Tutorial for cloud marker recognition - uncomment
        let tapToScanButtonItem:UIBarButtonItem=UIBarButtonItem(title: "tap to scan",
                                                                style: UIBarButtonItemStyle.plain,
                                                                target: self,
                                                                action: #selector(self.doRecognition(_:)))
        self.navigationItem.leftBarButtonItem=tapToScanButtonItem
        
        
        EAGLContext.setCurrent(self.context)
        // tutorial for cloud marker -- uncomment
        _blue_monkeyMesh = Mesh(meshFile: Bundle.main.path(forResource: "monkey", ofType: "json")!,
    ...
    override func glkView(_ view: GLKView, drawIn rect: CGRect) {
        ...
        if self.isTracking() {
            if let currentMarker = self.getCurrentMarker() {
                if (currentMarker.markerId! == "3_2002") {
                    ...
                    {
                        _blue_monkeyMesh!.DrawMesh(&mvpMatrix)
